...
Pathly is a Fabric Minecraft mod that makes landscaping
...
- The `"pathTopReplacablesScanDepth""` Gamerule specifies, how many blocks can be skipped vertically until a valid "pathable" block needs to be found
- The `"meleeHitsThroughBlocks"` Gamerule generally toggles the raycast pass through / melee pass through feature
